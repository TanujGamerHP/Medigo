...
const generateDefaultSlots = () => {
  ...
  for (let i = 0; i < 2; i++) {
    ...
    slots[dateStr] = i === 0 ? ["9:00 AM", "1:00 PM"] : ["10:00 AM", "2:00 PM"];
  }
  return slots;
};
      ...
      try {
        ...
        if (res.success && res.data) {
          ...
          setDoctor({
            ...
            imageInitials: `${docData.firstName.charAt(0)}${docData.lastName.charAt(0)}`.toUpperCase(),
            bio: docData.bio || "Clinical specialist providing virtual care and consultations.",
            fee: docData.consultationFee || 0,
            education: [],
            certifications: ["Board Certified"],
            slots: {
              [formatDate(today)]: ["9:00 AM", "1:00 PM", "3:00 PM"],
              [formatDate(tomorrow)]: ["10:00 AM", "2:00 PM", "4:30 PM"],
            }
          });
        }
      } catch (err) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-8 text-left">
          ...
          <div className="bg-white p-6 md:p-8 rounded-3xl border border-border/50 shadow-sm flex flex-col md:flex-row gap-6 items-center md:items-start text-center md:text-left">
            <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-primary-50 to-primary-100/50 border border-primary-200/30 text-primary-950 font-heading font-extrabold text-3xl flex items-center justify-center shadow-md shrink-0">
