...
export declare class PrescriptionsController {
    ...
    create(patientId: string, doctorId: string, appointmentId: string | null, diagnosis: string, medications: string, instructions: string, followUpDateStr: string | null, userId: string): Promise<{
        message: string;
        data: {
            id: string;
            status: import("@prisma/client").$Enums.PrescriptionStatus;
    ...
    updateStatus(id: string, status: PrescriptionStatus, userId: string): Promise<{
        message: string;
        data: {
            id: string;
            status: import("@prisma/client").$Enums.PrescriptionStatus;
