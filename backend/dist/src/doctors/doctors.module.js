...
const doctor_dashboard_controller_1 = require("./doctor-dashboard.controller");
...
exports.DoctorsModule = DoctorsModule = __decorate([
    (0, common_1.Module)({
        imports: [database_module_1.DatabaseModule, prescriptions_module_1.PrescriptionsModule],
        providers: [doctors_service_1.DoctorsService],
        controllers: [doctors_controller_1.DoctorsController, doctor_dashboard_controller_1.DoctorDashboardController],
