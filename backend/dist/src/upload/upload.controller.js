...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Upload file asset', description: 'Uploads images or PDFs up to 10MB.' }),
    (0, swagger_1.ApiBody)({
        schema: {
            type: 'object',
            properties: {
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid file format or file size exceeded 10MB.' }),
...
exports.UploadController = UploadController = __decorate([
    (0, swagger_1.ApiTags)('File Upload Module'),
